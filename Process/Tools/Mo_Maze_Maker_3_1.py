bl_info = {
    ...
    "description": "A maze generator exploring parsimony, with optional 'city Look' (blocks as clustered buildings).",
    "category": "Add Mesh",
}
...
# ──────────────────────────────────────────────────────────────────────────────
# Pathfinding (grid + optional uniqueness/overlap control)
# ──────────────────────────────────────────────────────────────────────────────
...
class MMM_OT_Generate(Operator):
    ...
    bl_label = "Generate Maze (or City Look)"
    bl_description = "Generate Prim's maze. If City Look is on, walls become clustered buildings."
    ...
    def execute(self, context):
        ...
        # Keep some dead-ends (optional gentle loop carving)
...
class MMM_PT_Main(Panel):
    ...
    def draw(self, context):
        ...
        L.operator("mmm.generate", icon='MESH_CUBE', text="Generate Maze (or City Look)")
